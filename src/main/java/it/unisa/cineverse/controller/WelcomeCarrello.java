...
/**
 * Servlet implementation class WelcomeCarrello
 */
@WebServlet("/WelcomeCarrello")
public class WelcomeCarrello extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("filmdelcarello", filmdamandare);
