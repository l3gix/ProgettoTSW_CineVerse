...
<aside id="side">
        ...
        <div class="voce">
            ...
            <div class="desc">
                <p>Panoramica dell account</p>
            </div>
            <div class="arrow">
                <button  onclick="window.location.href='<%= request.getContextPath() %>/common/WelcomeProfilo'">
		...
		<div class="voce">
            ...
            <div class="desc">
             ...
             <div class="arrow">
                <button  onclick="window.location.href='<%= request.getContextPath()%>/common/WelcomeModificaProfilo'">
                    <svg xmlns="http://www.w3.org/2000/svg" style="color: white;" width="30" height="30" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
                    </svg>
                </button>
            ...
            <div class="desc">
                <p>I Miei biglietti</p>
            </div>
             <div class="arrow">
                <button  onclick="window.location.href='<%= request.getContextPath() %>/common/WelcomeListaBiglietti'">
                    <svg xmlns="http://www.w3.org/2000/svg" style="color: white;" width="30" height="30" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
                    </svg>
                </button>
          ...
          <div class="voce">
           <div class="arrow">
                <button  onclick="window.location.href='<%= request.getContextPath() %>/WelcomeIndex'">
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" style="color:white;" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
            ...
            <div class="voce">
            <div class="arrow">
                <button  onclick="window.location.href='<%= request.getContextPath() %>/Logout'">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" style="color:white;" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
  				<path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5z"/>
				</svg>
                </button>
